...
export const recipesApi = createApi({
  ...
  endpoints: (builder) => ({
    getCategories: builder.query<Category[] | undefined, void>({
      query: () => "categories.php",
      transformResponse: (rawResult: { categories: Category[] }) =>
        rawResult.categories,
    }),

    getCategoryByName: builder.query<Meal[], string>({
      query: (categoryName) => `filter.php?c=${categoryName}`,
      transformResponse: (rawResult: { meals: Meal[] }) => rawResult.meals,
    }),
